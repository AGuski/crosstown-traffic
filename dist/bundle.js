...
const canvas_object_1 = __webpack_require__(1);
class Lane extends canvas_object_1.CanvasObject {
    constructor(id, startPoint, endPoint, controlPoints) {
        super({
            pathString: Lane.getPathString(startPoint, endPoint, controlPoints),
...
class CanvasObject {
    constructor(options) {
        ...
        if (options.pathString) {
            this.element = this.engine.add(options.pathString, options.group ? options.group : undefined);
        }
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const world_1 = __webpack_require__(5);
const Snap = __webpack_require__(6);
class Engine {
    constructor() {
...
Object.defineProperty(exports, "__esModule", { value: true });
class Utils {
    static getCenterDistance(pathA, pathB) {
    ...
    static getIntersection(origin1, dir1, origin2, dir2) {
    ...
    static getLengthFromPoint(path, targetPoint) {
        const margin = 0.5;
...
Object.defineProperty(exports, "__esModule", { value: true });
const lane_1 = __webpack_require__(0);
const junction_lane_1 = __webpack_require__(7);
const car_1 = __webpack_require__(8);
const engine_1 = __webpack_require__(2);
...
let laneCounter = 0;
world.lanes = [
    new lane_1.Lane(laneCounter++, { x: 40, y: 20 }, { x: 140, y: 100 }, [{ x: 110, y: 55 }]),
    new lane_1.Lane(laneCounter++, { x: 140, y: 130 }, { x: 40, y: 180 }),
    new lane_1.Lane(laneCounter++, { x: 180, y: 120 }, { x: 280, y: 120 }),
    new lane_1.Lane(laneCounter++, { x: 163, y: 140 }, { x: 213, y: 230 }),
    new lane_1.Lane(laneCounter++, { x: 300, y: 140 }, { x: 250, y: 245 }, [{ x: 300, y: 200 }]),
    new lane_1.Lane(laneCounter++, { x: 210, y: 255 }, { x: 60, y: 255 }),
    new lane_1.Lane(laneCounter++, { x: 370, y: 20 }, { x: 305, y: 100 }),
    new lane_1.Lane(laneCounter++, { x: 315, y: 108 }, { x: 380, y: 28 }),
    new lane_1.Lane(laneCounter++, { x: 225, y: 230 }, { x: 175, y: 140 }),
    new lane_1.Lane(laneCounter++, { x: 145, y: 90 }, { x: 48, y: 10 }, [{ x: 118, y: 45 }]),
];
// 10
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[0], world.lanes[1]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[0], world.lanes[3]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[0], world.lanes[2]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[3], world.lanes[5]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[2], world.lanes[4]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[4], world.lanes[5]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[6], world.lanes[4]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[2], world.lanes[7]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[4], world.lanes[8]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[8], world.lanes[2]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[8], world.lanes[1]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[8], world.lanes[9]));
// new world.lanes 
//22
world.lanes.push(new lane_1.Lane(laneCounter++, { x: 375, y: 275 }, { x: 250, y: 265 }, [{ x: 355, y: 280 }, { x: 285, y: 300 }]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[22], world.lanes[8]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[22], world.lanes[5]));
world.lanes.push(new lane_1.Lane(laneCounter++, { x: 242, y: 273 }, { x: 378, y: 290 }, [{ x: 280, y: 315 }, { x: 355, y: 295 }]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[3], world.lanes[25]));
world.lanes.push(new junction_lane_1.JunctionLane(laneCounter++, world.lanes[4], world.lanes[25]));
// yieldToLanesTest
...
class CarEntry {
    constructor(lane, interval) {
        setInterval(() => {
            world.cars.push(new car_1.Car(carIdCounter++, lane, 0));
...
const lane_1 = __webpack_require__(0);
class JunctionLane extends lane_1.Lane {
    constructor(id, fromLane, toLane) {
        let intersection = utils_1.Utils.getIntersection(fromLane.endPoint, fromLane.endAngle, toLane.startPoint, toLane.startAngle);
...
exports.JunctionLane = JunctionLane;
...
const utils_1 = __webpack_require__(3);
const canvas_object_1 = __webpack_require__(1);
class Car extends canvas_object_1.CanvasObject {
    constructor(id, lane, position) {
    ...
    update() {
        if (this.lanePos < this.lane.length) {
            ...
            if (this.useNavigation) {
                ...
                this.setLane(this.lane.nextLanes[Math.floor(Math.random() * this.lane.nextLanes.length)], 0);
            }
        }
        else {
    ...
    checkForCollision() {
        ...
        currentCars.forEach(car => {
            if (car.id !== this.id &&
                utils_1.Utils.getCenterDistance(car.element, this.element) <= 14) {
                ...
                else if (this.crashed && utils_1.Utils.getCenterDistance(car.element, this.element) > 20) {
                    this.crashed = false;
                }
                ///
            }
